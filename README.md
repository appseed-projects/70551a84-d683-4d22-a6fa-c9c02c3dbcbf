...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-06-28 12:24`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/70551a84-d683-4d22-a6fa-c9c02c3dbcbf.git
$ cd 70551a84-d683-4d22-a6fa-c9c02c3dbcbf
```
